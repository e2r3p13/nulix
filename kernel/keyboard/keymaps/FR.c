/* kernel/keyboard/keymaps/US104.c
 *
...
struct kbd_keymap_entry FR_getkeymapentry(enum kbd_keycode kc) {
	static struct kbd_keymap_entry keymap[0xFF] = {
		...
		[KEY_TAB]						= { NO_MOD           , '\t'                },
		[KEY_Q] 						= { CAPSLOCK         , 'a'  ,  'A'  ,  0   },
		[KEY_W] 						= { CAPSLOCK         , 'z'  ,  'Z'  ,  0   },
		...
		[KEY_CLOSING_SQUARE_BRACKET] 	= { 0                , '$'  ,   0   ,  0   },
		[KEY_ENTER] 					= { NO_MOD           , '\n'                },
		[KEY_A] 						= { CAPSLOCK         , 'q'  ,  'Q'  ,  0   },
		...
		[KEY_COLON] 					= { 0                , 'm'  ,  'M'  ,  0   },
		[KEY_SINGLE_QUOTE] 				= { 0                ,  0   ,  '%'  ,  0   },
		[KEY_BACKTICK] 					= {                                        },
		[KEY_BACKSLASH] 				= { 0                ,  0   ,  '*'  ,  0   },
		[KEY_Z] 						= { CAPSLOCK         , 'w'  ,  'W'  ,  0   },
